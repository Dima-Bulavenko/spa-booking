...
class TestPrintMixin(TestCase):
    ...
    def test_print_time_info(self, mock_table, mock_text, mock_padding, mock_print):
        time_ranges = [
    ...
    @patch("source.mixins.Text")
    @patch("source.mixins.Table")
    def test_print_booking_info(self, mock_table, mock_text, mock_padding, mock_print):
        booking_info = {"date": "2022-01-01", "start_time": "08:00", "end_time": "09:00"}
    ...
    def test_print_user_bookings(self, mock_text, mock_padding, mock_print):
        bookings = [
            {"booking": {"service": "service1", "date": "2022-01-01", "start_time": "08:00"}},
            {"booking": {"service": "service2", "date": "2022-01-02", "start_time": "09:00"}},
        ]
    ...
    @patch("source.mixins.Text")
    @patch("source.mixins.Panel")
    def test_print_service_info(self, mock_panel, mock_text, mock_padding, mock_print):
        service_info = {"name": "service1", "duration": 1, "price": 100, "description": "Some description"}

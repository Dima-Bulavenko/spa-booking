...
class ValidateIntegerOption(TestCase):
    ...
    def test_integer_less_then_min_numb(self):
        ...
        max_numb = 3
        message = (
            f"Please enter a number between {min_numb}"
...
class ValidateDate(TestCase):
    ...
    def test_date_in_past(self):
        data = "1999-12-30"
        message = (
            f"Your date {data} is in the past. Please enter a future date."
        )
...
class ValidateTime(TestCase):
    def setUp(self):
        ...
        self.time_ranges = [
            [
                datetime.combine(date_obj, time(8)),
                datetime.combine(date_obj, time(9)),
            ],
            [
                datetime.combine(date_obj, time(15)),
                datetime.combine(date_obj, time(16)),
            ],
            [
                datetime.combine(date_obj, time(17)),
                datetime.combine(date_obj, time(20)),
            ],
        ]
...
class ValidateSpaceSeparatedIntegers(TestCase):
    ...
    def test_valid_integers(self):
        data = "0 1 2 3"
        result = validate_space_separated_integers(
            data, self.min_numb, self.max_numb
        )
    ...
    def test_big_integer(self):
        data = "0 1 2 4"
        message = (
            f"Please enter a number between {self.min_numb}"
            f" and {self.max_numb} inclusive."
        )
    ...
    def test_same_integers(self):
        ...
        message = (
            f"Please enter each number only once. {same_int} is repeated."
        )

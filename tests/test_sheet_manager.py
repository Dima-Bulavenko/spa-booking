...
class TestSpaSheet(TestCase):
    ...
    def test_get_available_times_for_date_and_service(self):
        ...
        service = "service1"
        expected_result = [
            [datetime(2024, 2, 26, 12, 0), datetime(2024, 2, 26, 14, 0)],
        ...
        result = self.sheet.get_available_times_for_date_and_service(
            date_str, service
        )
    ...
    def test_no_available_times(self):
        ...
        first_start_time = datetime.combine(
            date_obj, time.fromisoformat("08:00")
        )
